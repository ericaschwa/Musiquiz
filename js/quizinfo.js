...
app.controller('songs', function($scope, $http) {
		$scope.genquiz = function(i, url) {
				...
				quiz.innerHTML += "<div "+ class_item + 
				                ...
				                + "<div class='answer' name='question" + i/4 + "' value='0'> "+  options[0] + "</div>"
				                + "<div class='answer' name='question" + i/4 + "' value='1'> "+  options[1] + "</div>"
				                + "<div class='answer' name='question" + i/4 + "' value='2'> "+  options[2] + "</div>"
				                + "<div class='answer' name='question" + i/4 + "' value='3'> "+  options[3] + "</div> <p class='question_no'> Question: "+ quest_no +" / 10 </p> </div></div>"
  	}
		...
		$scope.sendResults = function () {
			...
			var params = "player_name=" + login + "&score_pop=" + score_pop + "&score_rock="+ score_rock +"&score_jazz=" + score_jazz + "&score_country=" + score_country+"&player_id="+player_id;
			request.send(params);
		}
